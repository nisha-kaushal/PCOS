...
To return to the question of "what are the most discussed topics of concern within the PCOS community?", it seems that my suspicion was *partly* correct: ***a large portion of topics covered in the subreddit submissions are related to weight and ovulation.*** This can be seen through the WordClouds and bigrams created. I did not expect there to be heavy emphasis on appearance, and supplements/medication. <br>
